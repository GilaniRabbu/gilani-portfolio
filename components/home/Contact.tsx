...
export default function Contact() {
  return (
    <section className="py-20 bg-[#111111]">
      <ContainerWrapper>
        <h2 className="text-6xl font-bold mb-10 text-green-500">Contact Me</h2>
        <div className="flex flex-col justify-center items-center">
          <p className="mb-10 w-full md:w-3/5 mx-auto sm:text-lg tracking-wide text-pretty text-left text-gray-200 md:text-balance md:text-center">
