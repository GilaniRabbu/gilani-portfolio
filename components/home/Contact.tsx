...
export default function Contact() {
  return (
    <section className="py-20 bg-[#111111]">
      <ContainerWrapper>
        <h2 className="text-center mb-10 text-3xl text-white">Contact Me</h2>
        <div className="flex flex-col justify-center items-center">
          <p className="mb-10 w-full md:w-3/5 mx-auto text-lg tracking-wide text-pretty text-left text-white md:text-balance md:text-center">
